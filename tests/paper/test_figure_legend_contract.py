...
REQUIRED_PHRASES = {
    ...
    "fig:demography-mating-limits": ("120 paired", "100-kb", "lines are medians", "vertical connectors", "Gray estimates", "cobalt estimates", "exact simulated map", "Dashed black", "dotted cobalt", "meiotic references"),
    "fig:arabis-cross": ("742 offspring", "12", "25", "2-Mb", "open symbols", "95\\% chromosome-bootstrap", "structured-selfing"),
    "fig:resolution": ("2 Mb to 25 kb", "exact profile", "all three methods", "same dashed HapMap"),
    "fig:gene-conversion": ("25-kb", "four", "three mean tract lengths", "95\\%", "2,000 bootstrap", "24 recombination-map replicates", "regional mean"),
    "fig:unphased": ("phased", "unphased", "Points show species", "Dashed reference maps", "cobalt predictions", "95\\% prediction bounds", "No genotype was pseudo-phased"),
    "fig:relernn-scale": ("hotspot length", "per-SNP", "broad-window", "standard errors", "25-kb", "GRU"),
