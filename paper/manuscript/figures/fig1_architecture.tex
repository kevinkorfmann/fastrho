...
\draw[frink,line width=1.45pt] (4.26,6.25) -- (4.26,6.84);
\draw[frblue,line width=1.45pt] (4.73,6.25) -- (4.73,6.84);
...
\node[smallnote,text=frblue,anchor=south east] at (7.18,7.38)
  {LD radii 5, 25, 50 kb};
\node[smallnote,text=frink,anchor=south] at (4.26,6.84) {focal SNP};
