...
export DEMO_RELERNN_BSCORRECT_PATCH="${RESPONSE_REPO}/research/demography_matched/patches/relernn_keras3_bscorrect.patch"
export RELERNN_SOFTWARE_ROOT="${RELERNN_SOFTWARE_ROOT:-${RESPONSE_ROOT}}"
export ReLERNN_BSCORRECT_EXECUTABLE="${RELERNN_SOFTWARE_ROOT}/software/relernn-keras3-bscorrect/ReLERNN/ReLERNN_BSCORRECT"
...
export PYTHONPATH="${DEMO_RELERNNSRC}:${RESPONSE_REPO}${PYTHONPATH:+:${PYTHONPATH}}"
export PATH="${DEMO_RELERNN_ENV}/bin:${PATH}"
